...
model_file=os.path.join(os.getcwd(),"project", "Model", "chatbot_model.h5")
words_file=os.path.join(os.getcwd(),"project", "Model", "words.pkl")
classes_file=os.path.join(os.getcwd(),"project", "Model", "classes.pkl")
